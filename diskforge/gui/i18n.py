...
# v0.10 CPC standard/extended DSK read-only inspector.
CATALOG["zh_CN"].update({"Inspect / export CPC DSK…": "检查 / 导出 CPC DSK…", "Inspect CPC DSK image": "检查 CPC DSK 映像", "CPC DSK files (*.dsk);;All files (*)": "CPC DSK 文件 (*.dsk);;所有文件 (*)", "Inspecting CPC DSK image": "正在检查 CPC DSK 映像", "CPC DSK inspection": "CPC DSK 检查", "Container kind": "容器种类", "Creator": "创建者", "Sector IDs": "扇区 ID", "Exporting CPC DSK to RAW": "正在将 CPC DSK 导出为 RAW", "Exported proven CPC DSK layout to {path}": "已将经证明的 CPC DSK 布局导出到 {path}"})
CATALOG["es"].update({"Inspect / export CPC DSK…": "Inspeccionar / exportar CPC DSK…", "Inspect CPC DSK image": "Inspeccionar imagen CPC DSK", "CPC DSK files (*.dsk);;All files (*)": "Archivos CPC DSK (*.dsk);;Todos los archivos (*)", "Inspecting CPC DSK image": "Inspeccionando imagen CPC DSK", "CPC DSK inspection": "Inspección CPC DSK", "Container kind": "Tipo de contenedor", "Creator": "Creador", "Sector IDs": "ID de sector", "Exporting CPC DSK to RAW": "Exportando CPC DSK a RAW", "Exported proven CPC DSK layout to {path}": "Diseño CPC DSK comprobado exportado a {path}"})
CATALOG["fr"].update({"Inspect / export CPC DSK…": "Inspecter / exporter CPC DSK…", "Inspect CPC DSK image": "Inspecter l’image CPC DSK", "CPC DSK files (*.dsk);;All files (*)": "Fichiers CPC DSK (*.dsk);;Tous les fichiers (*)", "Inspecting CPC DSK image": "Inspection de l’image CPC DSK", "CPC DSK inspection": "Inspection CPC DSK", "Container kind": "Type de conteneur", "Creator": "Créateur", "Sector IDs": "Identifiants de secteur", "Exporting CPC DSK to RAW": "Exportation de CPC DSK vers RAW", "Exported proven CPC DSK layout to {path}": "Disposition CPC DSK prouvée exportée vers {path}"})
CATALOG["ru"].update({"Inspect / export CPC DSK…": "Проверить / экспортировать CPC DSK…", "Inspect CPC DSK image": "Проверить образ CPC DSK", "CPC DSK files (*.dsk);;All files (*)": "Файлы CPC DSK (*.dsk);;Все файлы (*)", "Inspecting CPC DSK image": "Проверка образа CPC DSK", "CPC DSK inspection": "Проверка CPC DSK", "Container kind": "Тип контейнера", "Creator": "Создатель", "Sector IDs": "Идентификаторы секторов", "Exporting CPC DSK to RAW": "Экспорт CPC DSK в RAW", "Exported proven CPC DSK layout to {path}": "Проверенная структура CPC DSK экспортирована в {path}"})
CATALOG["ar"].update({"Inspect / export CPC DSK…": "فحص / تصدير CPC DSK…", "Inspect CPC DSK image": "فحص صورة CPC DSK", "CPC DSK files (*.dsk);;All files (*)": "ملفات CPC DSK (*.dsk);;كل الملفات (*)", "Inspecting CPC DSK image": "جارٍ فحص صورة CPC DSK", "CPC DSK inspection": "فحص CPC DSK", "Container kind": "نوع الحاوية", "Creator": "المنشئ", "Sector IDs": "معرّفات القطاعات", "Exporting CPC DSK to RAW": "جارٍ تصدير CPC DSK إلى RAW", "Exported proven CPC DSK layout to {path}": "تم تصدير مخطط CPC DSK المثبت إلى {path}"})
CATALOG["ja"].update({"Inspect / export CPC DSK…": "CPC DSK を検査 / エクスポート…", "Inspect CPC DSK image": "CPC DSK イメージを検査", "CPC DSK files (*.dsk);;All files (*)": "CPC DSK ファイル (*.dsk);;すべてのファイル (*)", "Inspecting CPC DSK image": "CPC DSK イメージを検査中", "CPC DSK inspection": "CPC DSK 検査", "Container kind": "コンテナー種別", "Creator": "作成者", "Sector IDs": "セクター ID", "Exporting CPC DSK to RAW": "CPC DSK を RAW にエクスポート中", "Exported proven CPC DSK layout to {path}": "証明済み CPC DSK レイアウトを {path} にエクスポートしました"})


# v0.10 D88 read-only inspector.
CATALOG["zh_CN"].update({"Inspect / export D88…":"检查 / 导出 D88…","Inspect D88 image":"检查 D88 映像","D88 files (*.d88 *.1dd *.2dd);;All files (*)":"D88 文件 (*.d88 *.1dd *.2dd);;所有文件 (*)","Inspecting D88 image":"正在检查 D88 映像","D88 inspection":"D88 检查","Name":"名称","Media type":"介质类型","Exporting D88 to RAW":"正在将 D88 导出为 RAW","Exported proven D88 layout to {path}":"已将经证明的 D88 布局导出到 {path}"})
CATALOG["es"].update({"Inspect / export D88…":"Inspeccionar / exportar D88…","Inspect D88 image":"Inspeccionar imagen D88","D88 files (*.d88 *.1dd *.2dd);;All files (*)":"Archivos D88 (*.d88 *.1dd *.2dd);;Todos los archivos (*)","Inspecting D88 image":"Inspeccionando imagen D88","D88 inspection":"Inspección D88","Name":"Nombre","Media type":"Tipo de medio","Exporting D88 to RAW":"Exportando D88 a RAW","Exported proven D88 layout to {path}":"Diseño D88 comprobado exportado a {path}"})
CATALOG["fr"].update({"Inspect / export D88…":"Inspecter / exporter D88…","Inspect D88 image":"Inspecter l’image D88","D88 files (*.d88 *.1dd *.2dd);;All files (*)":"Fichiers D88 (*.d88 *.1dd *.2dd);;Tous les fichiers (*)","Inspecting D88 image":"Inspection de l’image D88","D88 inspection":"Inspection D88","Name":"Nom","Media type":"Type de média","Exporting D88 to RAW":"Exportation de D88 vers RAW","Exported proven D88 layout to {path}":"Disposition D88 prouvée exportée vers {path}"})
CATALOG["ru"].update({"Inspect / export D88…":"Проверить / экспортировать D88…","Inspect D88 image":"Проверить образ D88","D88 files (*.d88 *.1dd *.2dd);;All files (*)":"Файлы D88 (*.d88 *.1dd *.2dd);;Все файлы (*)","Inspecting D88 image":"Проверка образа D88","D88 inspection":"Проверка D88","Name":"Имя","Media type":"Тип носителя","Exporting D88 to RAW":"Экспорт D88 в RAW","Exported proven D88 layout to {path}":"Проверенная структура D88 экспортирована в {path}"})
CATALOG["ar"].update({"Inspect / export D88…":"فحص / تصدير D88…","Inspect D88 image":"فحص صورة D88","D88 files (*.d88 *.1dd *.2dd);;All files (*)":"ملفات D88 (*.d88 *.1dd *.2dd);;كل الملفات (*)","Inspecting D88 image":"جارٍ فحص صورة D88","D88 inspection":"فحص D88","Name":"الاسم","Media type":"نوع الوسيط","Exporting D88 to RAW":"جارٍ تصدير D88 إلى RAW","Exported proven D88 layout to {path}":"تم تصدير مخطط D88 المثبت إلى {path}"})
CATALOG["ja"].update({"Inspect / export D88…":"D88 を検査 / エクスポート…","Inspect D88 image":"D88 イメージを検査","D88 files (*.d88 *.1dd *.2dd);;All files (*)":"D88 ファイル (*.d88 *.1dd *.2dd);;すべてのファイル (*)","Inspecting D88 image":"D88 イメージを検査中","D88 inspection":"D88 検査","Name":"名前","Media type":"メディア種別","Exporting D88 to RAW":"D88 を RAW にエクスポート中","Exported proven D88 layout to {path}":"証明済み D88 レイアウトを {path} にエクスポートしました"})


# v0.10 HFE bitstream-container inspector.
CATALOG["zh_CN"].update({"Inspect HFE structure…":"检查 HFE 结构…","Inspect HFE structure":"检查 HFE 结构","HFE files (*.hfe);;All files (*)":"HFE 文件 (*.hfe);;所有文件 (*)","Inspecting HFE structure":"正在检查 HFE 结构","HFE structure":"HFE 结构","Bitstream decoding":"位流解码","Not available":"不可用","Bitrate":"位率","RPM":"转/分钟","Unreferenced bytes":"未引用字节","bytes":"字节"})
CATALOG["es"].update({"Inspect HFE structure…":"Inspeccionar estructura HFE…","Inspect HFE structure":"Inspeccionar estructura HFE","HFE files (*.hfe);;All files (*)":"Archivos HFE (*.hfe);;Todos los archivos (*)","Inspecting HFE structure":"Inspeccionando estructura HFE","HFE structure":"Estructura HFE","Bitstream decoding":"Decodificación de flujo de bits","Not available":"No disponible","Bitrate":"Tasa de bits","RPM":"RPM","Unreferenced bytes":"Bytes no referenciados","bytes":"bytes"})
CATALOG["fr"].update({"Inspect HFE structure…":"Inspecter la structure HFE…","Inspect HFE structure":"Inspecter la structure HFE","HFE files (*.hfe);;All files (*)":"Fichiers HFE (*.hfe);;Tous les fichiers (*)","Inspecting HFE structure":"Inspection de la structure HFE","HFE structure":"Structure HFE","Bitstream decoding":"Décodage du flux binaire","Not available":"Indisponible","Bitrate":"Débit binaire","RPM":"tr/min","Unreferenced bytes":"Octets non référencés","bytes":"octets"})
CATALOG["ru"].update({"Inspect HFE structure…":"Проверить структуру HFE…","Inspect HFE structure":"Проверить структуру HFE","HFE files (*.hfe);;All files (*)":"Файлы HFE (*.hfe);;Все файлы (*)","Inspecting HFE structure":"Проверка структуры HFE","HFE structure":"Структура HFE","Bitstream decoding":"Декодирование битового потока","Not available":"Недоступно","Bitrate":"Битрейт","RPM":"об/мин","Unreferenced bytes":"Несвязанные байты","bytes":"байты"})
CATALOG["ar"].update({"Inspect HFE structure…":"فحص بنية HFE…","Inspect HFE structure":"فحص بنية HFE","HFE files (*.hfe);;All files (*)":"ملفات HFE (*.hfe);;كل الملفات (*)","Inspecting HFE structure":"جارٍ فحص بنية HFE","HFE structure":"بنية HFE","Bitstream decoding":"فك ترميز تدفق البتات","Not available":"غير متاح","Bitrate":"معدل البت","RPM":"دورة/دقيقة","Unreferenced bytes":"بايتات غير مشار إليها","bytes":"بايت"})
CATALOG["ja"].update({"Inspect HFE structure…":"HFE 構造を検査…","Inspect HFE structure":"HFE 構造を検査","HFE files (*.hfe);;All files (*)":"HFE ファイル (*.hfe);;すべてのファイル (*)","Inspecting HFE structure":"HFE 構造を検査中","HFE structure":"HFE 構造","Bitstream decoding":"ビットストリームの復号","Not available":"利用不可","Bitrate":"ビットレート","RPM":"RPM","Unreferenced bytes":"未参照バイト","bytes":"バイト"})


# v0.10 Disk Copy 4.2 (DC42) read-only inspector and verified data-fork export.
CATALOG["zh_CN"].update({"Inspect / export DC42…":"检查 / 导出 DC42…","Inspect DC42 image":"检查 DC42 映像","DC42 files (*.dc42);;All files (*)":"DC42 文件 (*.dc42);;所有文件 (*)","Inspecting DC42 image":"正在检查 DC42 映像","DC42 inspection":"DC42 检查","Data fork":"数据叉","Tag fork":"标签叉","Encoding":"编码","Format":"格式","Exporting DC42 data fork to RAW":"正在将 DC42 数据叉导出为 RAW","Exported DC42 data fork to {path}":"已将 DC42 数据叉导出到 {path}"})
CATALOG["es"].update({"Inspect / export DC42…":"Inspeccionar / exportar DC42…","Inspect DC42 image":"Inspeccionar imagen DC42","DC42 files (*.dc42);;All files (*)":"Archivos DC42 (*.dc42);;Todos los archivos (*)","Inspecting DC42 image":"Inspeccionando imagen DC42","DC42 inspection":"Inspección DC42","Data fork":"Bifurcación de datos","Tag fork":"Bifurcación de etiquetas","Encoding":"Codificación","Format":"Formato","Exporting DC42 data fork to RAW":"Exportando la bifurcación de datos DC42 a RAW","Exported DC42 data fork to {path}":"Bifurcación de datos DC42 exportada a {path}"})
CATALOG["fr"].update({"Inspect / export DC42…":"Inspecter / exporter DC42…","Inspect DC42 image":"Inspecter l’image DC42","DC42 files (*.dc42);;All files (*)":"Fichiers DC42 (*.dc42);;Tous les fichiers (*)","Inspecting DC42 image":"Inspection de l’image DC42","DC42 inspection":"Inspection DC42","Data fork":"Fourche de données","Tag fork":"Fourche d’étiquettes","Encoding":"Encodage","Format":"Format du support","Exporting DC42 data fork to RAW":"Exportation de la fourche de données DC42 vers RAW","Exported DC42 data fork to {path}":"Fourche de données DC42 exportée vers {path}"})
CATALOG["ru"].update({"Inspect / export DC42…":"Проверить / экспортировать DC42…","Inspect DC42 image":"Проверить образ DC42","DC42 files (*.dc42);;All files (*)":"Файлы DC42 (*.dc42);;Все файлы (*)","Inspecting DC42 image":"Проверка образа DC42","DC42 inspection":"Проверка DC42","Data fork":"Ветка данных","Tag fork":"Ветка тегов","Encoding":"Кодировка","Format":"Формат","Exporting DC42 data fork to RAW":"Экспорт ветки данных DC42 в RAW","Exported DC42 data fork to {path}":"Ветка данных DC42 экспортирована в {path}"})
CATALOG["ar"].update({"Inspect / export DC42…":"فحص / تصدير DC42…","Inspect DC42 image":"فحص صورة DC42","DC42 files (*.dc42);;All files (*)":"ملفات DC42 (*.dc42);;كل الملفات (*)","Inspecting DC42 image":"جارٍ فحص صورة DC42","DC42 inspection":"فحص DC42","Data fork":"تشعّب البيانات","Tag fork":"تشعّب الوسوم","Encoding":"الترميز","Format":"التنسيق","Exporting DC42 data fork to RAW":"جارٍ تصدير تشعّب بيانات DC42 إلى RAW","Exported DC42 data fork to {path}":"تم تصدير تشعّب بيانات DC42 إلى {path}"})
CATALOG["ja"].update({"Inspect / export DC42…":"DC42 を検査 / エクスポート…","Inspect DC42 image":"DC42 イメージを検査","DC42 files (*.dc42);;All files (*)":"DC42 ファイル (*.dc42);;すべてのファイル (*)","Inspecting DC42 image":"DC42 イメージを検査中","DC42 inspection":"DC42 検査","Data fork":"データフォーク","Tag fork":"タグフォーク","Encoding":"エンコーディング","Format":"形式","Exporting DC42 data fork to RAW":"DC42 データフォークを RAW にエクスポート中","Exported DC42 data fork to {path}":"DC42 データフォークを {path} にエクスポートしました"})


# v0.10 Apple II 2MG/2IMG read-only inspector and verified data-block export.
CATALOG["zh_CN"].update({"Inspect / export 2MG…":"检查 / 导出 2MG…","Inspect 2MG image":"检查 2MG 映像","2MG files (*.2mg *.2img);;All files (*)":"2MG 文件 (*.2mg *.2img);;所有文件 (*)","Inspecting 2MG image":"正在检查 2MG 映像","2MG inspection":"2MG 检查","Data block":"数据块","Volume number":"卷号","Write protected":"写保护","Creator data":"创建者数据","Exporting 2MG data block to RAW":"正在将 2MG 数据块导出为 RAW","Exported 2MG data block to {path}":"已将 2MG 数据块导出到 {path}"})
CATALOG["es"].update({"Inspect / export 2MG…":"Inspeccionar / exportar 2MG…","Inspect 2MG image":"Inspeccionar imagen 2MG","2MG files (*.2mg *.2img);;All files (*)":"Archivos 2MG (*.2mg *.2img);;Todos los archivos (*)","Inspecting 2MG image":"Inspeccionando imagen 2MG","2MG inspection":"Inspección 2MG","Data block":"Bloque de datos","Volume number":"Número de volumen","Write protected":"Protegido contra escritura","Creator data":"Datos del creador","Exporting 2MG data block to RAW":"Exportando bloque de datos 2MG a RAW","Exported 2MG data block to {path}":"Bloque de datos 2MG exportado a {path}"})
CATALOG["fr"].update({"Inspect / export 2MG…":"Inspecter / exporter 2MG…","Inspect 2MG image":"Inspecter l’image 2MG","2MG files (*.2mg *.2img);;All files (*)":"Fichiers 2MG (*.2mg *.2img);;Tous les fichiers (*)","Inspecting 2MG image":"Inspection de l’image 2MG","2MG inspection":"Inspection 2MG","Data block":"Bloc de données","Volume number":"Numéro de volume","Write protected":"Protégé en écriture","Creator data":"Données du créateur","Exporting 2MG data block to RAW":"Exportation du bloc de données 2MG vers RAW","Exported 2MG data block to {path}":"Bloc de données 2MG exporté vers {path}"})
CATALOG["ru"].update({"Inspect / export 2MG…":"Проверить / экспортировать 2MG…","Inspect 2MG image":"Проверить образ 2MG","2MG files (*.2mg *.2img);;All files (*)":"Файлы 2MG (*.2mg *.2img);;Все файлы (*)","Inspecting 2MG image":"Проверка образа 2MG","2MG inspection":"Проверка 2MG","Data block":"Блок данных","Volume number":"Номер тома","Write protected":"Защищён от записи","Creator data":"Данные создателя","Exporting 2MG data block to RAW":"Экспорт блока данных 2MG в RAW","Exported 2MG data block to {path}":"Блок данных 2MG экспортирован в {path}"})
CATALOG["ar"].update({"Inspect / export 2MG…":"فحص / تصدير 2MG…","Inspect 2MG image":"فحص صورة 2MG","2MG files (*.2mg *.2img);;All files (*)":"ملفات 2MG (*.2mg *.2img);;كل الملفات (*)","Inspecting 2MG image":"جارٍ فحص صورة 2MG","2MG inspection":"فحص 2MG","Data block":"كتلة البيانات","Volume number":"رقم وحدة التخزين","Write protected":"محمي من الكتابة","Creator data":"بيانات المنشئ","Exporting 2MG data block to RAW":"جارٍ تصدير كتلة بيانات 2MG إلى RAW","Exported 2MG data block to {path}":"تم تصدير كتلة بيانات 2MG إلى {path}"})
CATALOG["ja"].update({"Inspect / export 2MG…":"2MG を検査 / エクスポート…","Inspect 2MG image":"2MG イメージを検査","2MG files (*.2mg *.2img);;All files (*)":"2MG ファイル (*.2mg *.2img);;すべてのファイル (*)","Inspecting 2MG image":"2MG イメージを検査中","2MG inspection":"2MG 検査","Data block":"データブロック","Volume number":"ボリューム番号","Write protected":"書き込み保護","Creator data":"作成者データ","Exporting 2MG data block to RAW":"2MG データブロックを RAW にエクスポート中","Exported 2MG data block to {path}":"2MG データブロックを {path} にエクスポートしました"})


# v0.10 APRIDISK read-only sector-container inspector and strict RAW export.
CATALOG["zh_CN"].update({"Inspect / export APRIDISK…":"检查 / 导出 APRIDISK…","Inspect APRIDISK image":"检查 APRIDISK 映像","APRIDISK files (*.dsk);;All files (*)":"APRIDISK 文件 (*.dsk);;所有文件 (*)","Inspecting APRIDISK image":"正在检查 APRIDISK 映像","APRIDISK inspection":"APRIDISK 检查","Records":"记录","Geometry":"几何结构","Bytes per sector":"每扇区字节数","Deleted records":"已删除记录","Exporting APRIDISK to RAW":"正在将 APRIDISK 导出为 RAW","Exported proven APRIDISK layout to {path}":"已将经证明的 APRIDISK 布局导出到 {path}"})
CATALOG["es"].update({"Inspect / export APRIDISK…":"Inspeccionar / exportar APRIDISK…","Inspect APRIDISK image":"Inspeccionar imagen APRIDISK","APRIDISK files (*.dsk);;All files (*)":"Archivos APRIDISK (*.dsk);;Todos los archivos (*)","Inspecting APRIDISK image":"Inspeccionando imagen APRIDISK","APRIDISK inspection":"Inspección APRIDISK","Records":"Registros","Geometry":"Geometría","Bytes per sector":"Bytes por sector","Deleted records":"Registros eliminados","Exporting APRIDISK to RAW":"Exportando APRIDISK a RAW","Exported proven APRIDISK layout to {path}":"Diseño APRIDISK comprobado exportado a {path}"})
CATALOG["fr"].update({"Inspect / export APRIDISK…":"Inspecter / exporter APRIDISK…","Inspect APRIDISK image":"Inspecter l’image APRIDISK","APRIDISK files (*.dsk);;All files (*)":"Fichiers APRIDISK (*.dsk);;Tous les fichiers (*)","Inspecting APRIDISK image":"Inspection de l’image APRIDISK","APRIDISK inspection":"Inspection APRIDISK","Records":"Enregistrements","Geometry":"Géométrie","Bytes per sector":"Octets par secteur","Deleted records":"Enregistrements supprimés","Exporting APRIDISK to RAW":"Exportation d’APRIDISK vers RAW","Exported proven APRIDISK layout to {path}":"Disposition APRIDISK prouvée exportée vers {path}"})
CATALOG["ru"].update({"Inspect / export APRIDISK…":"Проверить / экспортировать APRIDISK…","Inspect APRIDISK image":"Проверить образ APRIDISK","APRIDISK files (*.dsk);;All files (*)":"Файлы APRIDISK (*.dsk);;Все файлы (*)","Inspecting APRIDISK image":"Проверка образа APRIDISK","APRIDISK inspection":"Проверка APRIDISK","Records":"Записи","Geometry":"Геометрия","Bytes per sector":"Байт на сектор","Deleted records":"Удалённые записи","Exporting APRIDISK to RAW":"Экспорт APRIDISK в RAW","Exported proven APRIDISK layout to {path}":"Проверенная структура APRIDISK экспортирована в {path}"})
CATALOG["ar"].update({"Inspect / export APRIDISK…":"فحص / تصدير APRIDISK…","Inspect APRIDISK image":"فحص صورة APRIDISK","APRIDISK files (*.dsk);;All files (*)":"ملفات APRIDISK (*.dsk);;كل الملفات (*)","Inspecting APRIDISK image":"جارٍ فحص صورة APRIDISK","APRIDISK inspection":"فحص APRIDISK","Records":"السجلات","Geometry":"الهندسة","Bytes per sector":"بايت لكل قطاع","Deleted records":"السجلات المحذوفة","Exporting APRIDISK to RAW":"جارٍ تصدير APRIDISK إلى RAW","Exported proven APRIDISK layout to {path}":"تم تصدير مخطط APRIDISK المثبت إلى {path}"})
CATALOG["ja"].update({"Inspect / export APRIDISK…":"APRIDISK を検査 / エクスポート…","Inspect APRIDISK image":"APRIDISK イメージを検査","APRIDISK files (*.dsk);;All files (*)":"APRIDISK ファイル (*.dsk);;すべてのファイル (*)","Inspecting APRIDISK image":"APRIDISK イメージを検査中","APRIDISK inspection":"APRIDISK 検査","Records":"レコード","Geometry":"ジオメトリ","Bytes per sector":"セクター当たりのバイト数","Deleted records":"削除済みレコード","Exporting APRIDISK to RAW":"APRIDISK を RAW にエクスポート中","Exported proven APRIDISK layout to {path}":"証明済み APRIDISK レイアウトを {path} にエクスポートしました"})


# v0.10 CopyQM checksum-verified read-only inspector and RAW export.
CATALOG["zh_CN"].update({"Inspect / export CopyQM…":"检查 / 导出 CopyQM…","Inspect CopyQM image":"检查 CopyQM 映像","CopyQM files (*.qm);;All files (*)":"CopyQM 文件 (*.qm);;所有文件 (*)","Inspecting CopyQM image":"正在检查 CopyQM 映像","CopyQM inspection":"CopyQM 检查","Data CRC":"数据 CRC","Media description":"介质描述","Density":"密度","Validated bytes":"已验证字节数","Exporting CopyQM to RAW":"正在将 CopyQM 导出为 RAW","Exported verified CopyQM image to {path}":"已将已验证的 CopyQM 映像导出到 {path}"})
CATALOG["es"].update({"Inspect / export CopyQM…":"Inspeccionar / exportar CopyQM…","Inspect CopyQM image":"Inspeccionar imagen CopyQM","CopyQM files (*.qm);;All files (*)":"Archivos CopyQM (*.qm);;Todos los archivos (*)","Inspecting CopyQM image":"Inspeccionando imagen CopyQM","CopyQM inspection":"Inspección CopyQM","Data CRC":"CRC de datos","Media description":"Descripción del medio","Density":"Densidad","Validated bytes":"Bytes validados","Exporting CopyQM to RAW":"Exportando CopyQM a RAW","Exported verified CopyQM image to {path}":"Imagen CopyQM validada exportada a {path}"})
CATALOG["fr"].update({"Inspect / export CopyQM…":"Inspecter / exporter CopyQM…","Inspect CopyQM image":"Inspecter l’image CopyQM","CopyQM files (*.qm);;All files (*)":"Fichiers CopyQM (*.qm);;Tous les fichiers (*)","Inspecting CopyQM image":"Inspection de l’image CopyQM","CopyQM inspection":"Inspection CopyQM","Data CRC":"CRC des données","Media description":"Description du support","Density":"Densité","Validated bytes":"Octets validés","Exporting CopyQM to RAW":"Exportation de CopyQM vers RAW","Exported verified CopyQM image to {path}":"Image CopyQM validée exportée vers {path}"})
CATALOG["ru"].update({"Inspect / export CopyQM…":"Проверить / экспортировать CopyQM…","Inspect CopyQM image":"Проверить образ CopyQM","CopyQM files (*.qm);;All files (*)":"Файлы CopyQM (*.qm);;Все файлы (*)","Inspecting CopyQM image":"Проверка образа CopyQM","CopyQM inspection":"Проверка CopyQM","Data CRC":"CRC данных","Media description":"Описание носителя","Density":"Плотность","Validated bytes":"Проверенные байты","Exporting CopyQM to RAW":"Экспорт CopyQM в RAW","Exported verified CopyQM image to {path}":"Проверенный образ CopyQM экспортирован в {path}"})
CATALOG["ar"].update({"Inspect / export CopyQM…":"فحص / تصدير CopyQM…","Inspect CopyQM image":"فحص صورة CopyQM","CopyQM files (*.qm);;All files (*)":"ملفات CopyQM (*.qm);;كل الملفات (*)","Inspecting CopyQM image":"جارٍ فحص صورة CopyQM","CopyQM inspection":"فحص CopyQM","Data CRC":"CRC البيانات","Media description":"وصف الوسيط","Density":"الكثافة","Validated bytes":"البايتات المتحقق منها","Exporting CopyQM to RAW":"جارٍ تصدير CopyQM إلى RAW","Exported verified CopyQM image to {path}":"تم تصدير صورة CopyQM المتحقق منها إلى {path}"})
CATALOG["ja"].update({"Inspect / export CopyQM…":"CopyQM を検査 / エクスポート…","Inspect CopyQM image":"CopyQM イメージを検査","CopyQM files (*.qm);;All files (*)":"CopyQM ファイル (*.qm);;すべてのファイル (*)","Inspecting CopyQM image":"CopyQM イメージを検査中","CopyQM inspection":"CopyQM 検査","Data CRC":"データ CRC","Media description":"媒体の説明","Density":"密度","Validated bytes":"検証済みバイト数","Exporting CopyQM to RAW":"CopyQM を RAW にエクスポート中","Exported verified CopyQM image to {path}":"検証済み CopyQM イメージを {path} にエクスポートしました"})


# v0.10 SAP Pukall-CRC read-only inspector and strict regular-layout RAW export.
CATALOG["zh_CN"].update({"Inspect / export SAP…":"检查 / 导出 SAP…","Inspect SAP image":"检查 SAP 映像","SAP files (*.sap);;All files (*)":"SAP 文件 (*.sap);;所有文件 (*)","Inspecting SAP image":"正在检查 SAP 映像","SAP inspection":"SAP 检查","Disk type":"磁盘类型","CRC errors":"CRC 错误","Protected sectors":"受保护扇区","Tracks per side":"每面轨道数","Heads":"磁头数","Sector records":"扇区记录","Exporting SAP to RAW":"正在将 SAP 导出为 RAW","Exported verified SAP layout to {path}":"已将已验证的 SAP 布局导出到 {path}"})
CATALOG["es"].update({"Inspect / export SAP…":"Inspeccionar / exportar SAP…","Inspect SAP image":"Inspeccionar imagen SAP","SAP files (*.sap);;All files (*)":"Archivos SAP (*.sap);;Todos los archivos (*)","Inspecting SAP image":"Inspeccionando imagen SAP","SAP inspection":"Inspección SAP","Disk type":"Tipo de disco","CRC errors":"Errores CRC","Protected sectors":"Sectores protegidos","Tracks per side":"Pistas por cara","Heads":"Cabezas","Sector records":"Registros de sector","Exporting SAP to RAW":"Exportando SAP a RAW","Exported verified SAP layout to {path}":"Diseño SAP validado exportado a {path}"})
CATALOG["fr"].update({"Inspect / export SAP…":"Inspecter / exporter SAP…","Inspect SAP image":"Inspecter l’image SAP","SAP files (*.sap);;All files (*)":"Fichiers SAP (*.sap);;Tous les fichiers (*)","Inspecting SAP image":"Inspection de l’image SAP","SAP inspection":"Inspection SAP","Disk type":"Type de disque","CRC errors":"Erreurs CRC","Protected sectors":"Secteurs protégés","Tracks per side":"Pistes par face","Heads":"Têtes","Sector records":"Enregistrements de secteur","Exporting SAP to RAW":"Exportation de SAP vers RAW","Exported verified SAP layout to {path}":"Disposition SAP validée exportée vers {path}"})
CATALOG["ru"].update({"Inspect / export SAP…":"Проверить / экспортировать SAP…","Inspect SAP image":"Проверить образ SAP","SAP files (*.sap);;All files (*)":"Файлы SAP (*.sap);;Все файлы (*)","Inspecting SAP image":"Проверка образа SAP","SAP inspection":"Проверка SAP","Disk type":"Тип диска","CRC errors":"Ошибки CRC","Protected sectors":"Защищённые секторы","Tracks per side":"Дорожек на сторону","Heads":"Головки","Sector records":"Записи секторов","Exporting SAP to RAW":"Экспорт SAP в RAW","Exported verified SAP layout to {path}":"Проверенная структура SAP экспортирована в {path}"})
CATALOG["ar"].update({"Inspect / export SAP…":"فحص / تصدير SAP…","Inspect SAP image":"فحص صورة SAP","SAP files (*.sap);;All files (*)":"ملفات SAP (*.sap);;كل الملفات (*)","Inspecting SAP image":"جارٍ فحص صورة SAP","SAP inspection":"فحص SAP","Disk type":"نوع القرص","CRC errors":"أخطاء CRC","Protected sectors":"قطاعات محمية","Tracks per side":"المسارات لكل وجه","Heads":"الرؤوس","Sector records":"سجلات القطاعات","Exporting SAP to RAW":"جارٍ تصدير SAP إلى RAW","Exported verified SAP layout to {path}":"تم تصدير مخطط SAP المتحقق منه إلى {path}"})
CATALOG["ja"].update({"Inspect / export SAP…":"SAP を検査 / エクスポート…","Inspect SAP image":"SAP イメージを検査","SAP files (*.sap);;All files (*)":"SAP ファイル (*.sap);;すべてのファイル (*)","Inspecting SAP image":"SAP イメージを検査中","SAP inspection":"SAP 検査","Disk type":"ディスクの種類","CRC errors":"CRC エラー","Protected sectors":"保護されたセクター","Tracks per side":"片面当たりのトラック数","Heads":"ヘッド数","Sector records":"セクターレコード","Exporting SAP to RAW":"SAP を RAW にエクスポート中","Exported verified SAP layout to {path}":"検証済み SAP レイアウトを {path} にエクスポートしました"})


# v0.10 Atari ST MSA track-container inspector and strict RAW export.
CATALOG["zh_CN"].update({"Inspect / export MSA…":"检查 / 导出 MSA…","Inspect MSA image":"检查 MSA 映像","MSA files (*.msa);;All files (*)":"MSA 文件 (*.msa);;所有文件 (*)","Inspecting MSA image":"正在检查 MSA 映像","MSA inspection":"MSA 检查","Track range":"轨道范围","Compressed tracks":"压缩轨道","Sectors per track":"每轨扇区数","Track records":"轨道记录","Exporting MSA to RAW":"正在将 MSA 导出为 RAW","Exported verified MSA tracks to {path}":"已将已验证的 MSA 轨道导出到 {path}"})
CATALOG["es"].update({"Inspect / export MSA…":"Inspeccionar / exportar MSA…","Inspect MSA image":"Inspeccionar imagen MSA","MSA files (*.msa);;All files (*)":"Archivos MSA (*.msa);;Todos los archivos (*)","Inspecting MSA image":"Inspeccionando imagen MSA","MSA inspection":"Inspección MSA","Track range":"Rango de pistas","Compressed tracks":"Pistas comprimidas","Sectors per track":"Sectores por pista","Track records":"Registros de pista","Exporting MSA to RAW":"Exportando MSA a RAW","Exported verified MSA tracks to {path}":"Pistas MSA verificadas exportadas a {path}"})
CATALOG["fr"].update({"Inspect / export MSA…":"Inspecter / exporter MSA…","Inspect MSA image":"Inspecter l’image MSA","MSA files (*.msa);;All files (*)":"Fichiers MSA (*.msa);;Tous les fichiers (*)","Inspecting MSA image":"Inspection de l’image MSA","MSA inspection":"Inspection MSA","Track range":"Plage de pistes","Compressed tracks":"Pistes compressées","Sectors per track":"Secteurs par piste","Track records":"Enregistrements de piste","Exporting MSA to RAW":"Exportation de MSA vers RAW","Exported verified MSA tracks to {path}":"Pistes MSA vérifiées exportées vers {path}"})
CATALOG["ru"].update({"Inspect / export MSA…":"Проверить / экспортировать MSA…","Inspect MSA image":"Проверить образ MSA","MSA files (*.msa);;All files (*)":"Файлы MSA (*.msa);;Все файлы (*)","Inspecting MSA image":"Проверка образа MSA","MSA inspection":"Проверка MSA","Track range":"Диапазон дорожек","Compressed tracks":"Сжатые дорожки","Sectors per track":"Секторов на дорожку","Track records":"Записи дорожек","Exporting MSA to RAW":"Экспорт MSA в RAW","Exported verified MSA tracks to {path}":"Проверенные дорожки MSA экспортированы в {path}"})
CATALOG["ar"].update({"Inspect / export MSA…":"فحص / تصدير MSA…","Inspect MSA image":"فحص صورة MSA","MSA files (*.msa);;All files (*)":"ملفات MSA (*.msa);;كل الملفات (*)","Inspecting MSA image":"جارٍ فحص صورة MSA","MSA inspection":"فحص MSA","Track range":"نطاق المسارات","Compressed tracks":"المسارات المضغوطة","Sectors per track":"القطاعات لكل مسار","Track records":"سجلات المسارات","Exporting MSA to RAW":"جارٍ تصدير MSA إلى RAW","Exported verified MSA tracks to {path}":"تم تصدير مسارات MSA المتحقق منها إلى {path}"})
CATALOG["ja"].update({"Inspect / export MSA…":"MSA を検査 / エクスポート…","Inspect MSA image":"MSA イメージを検査","MSA files (*.msa);;All files (*)":"MSA ファイル (*.msa);;すべてのファイル (*)","Inspecting MSA image":"MSA イメージを検査中","MSA inspection":"MSA 検査","Track range":"トラック範囲","Compressed tracks":"圧縮トラック","Sectors per track":"トラック当たりのセクター数","Track records":"トラックレコード","Exporting MSA to RAW":"MSA を RAW にエクスポート中","Exported verified MSA tracks to {path}":"検証済み MSA トラックを {path} にエクスポートしました"})


# v0.10 PSI checksummed sector-container inspector and strict RAW export.
CATALOG["zh_CN"].update({"Inspect / export PSI…":"检查 / 导出 PSI…","Inspect PSI image":"检查 PSI 映像","PSI files (*.psi);;All files (*)":"PSI 文件 (*.psi);;所有文件 (*)","Inspecting PSI image":"正在检查 PSI 映像","PSI inspection":"PSI 检查","Compressed sectors":"压缩扇区","Default format":"默认格式","Comment chunks":"注释块","Metadata chunks":"元数据块","Exporting PSI to RAW":"正在将 PSI 导出为 RAW","Exported verified PSI layout to {path}":"已将已验证的 PSI 布局导出到 {path}"})
CATALOG["es"].update({"Inspect / export PSI…":"Inspeccionar / exportar PSI…","Inspect PSI image":"Inspeccionar imagen PSI","PSI files (*.psi);;All files (*)":"Archivos PSI (*.psi);;Todos los archivos (*)","Inspecting PSI image":"Inspeccionando imagen PSI","PSI inspection":"Inspección PSI","Compressed sectors":"Sectores comprimidos","Default format":"Formato predeterminado","Comment chunks":"Bloques de comentarios","Metadata chunks":"Bloques de metadatos","Exporting PSI to RAW":"Exportando PSI a RAW","Exported verified PSI layout to {path}":"Diseño PSI validado exportado a {path}"})
CATALOG["fr"].update({"Inspect / export PSI…":"Inspecter / exporter PSI…","Inspect PSI image":"Inspecter l’image PSI","PSI files (*.psi);;All files (*)":"Fichiers PSI (*.psi);;Tous les fichiers (*)","Inspecting PSI image":"Inspection de l’image PSI","PSI inspection":"Inspection PSI","Compressed sectors":"Secteurs compressés","Default format":"Format par défaut","Comment chunks":"Blocs de commentaires","Metadata chunks":"Blocs de métadonnées","Exporting PSI to RAW":"Exportation de PSI vers RAW","Exported verified PSI layout to {path}":"Disposition PSI validée exportée vers {path}"})
CATALOG["ru"].update({"Inspect / export PSI…":"Проверить / экспортировать PSI…","Inspect PSI image":"Проверить образ PSI","PSI files (*.psi);;All files (*)":"Файлы PSI (*.psi);;Все файлы (*)","Inspecting PSI image":"Проверка образа PSI","PSI inspection":"Проверка PSI","Compressed sectors":"Сжатые секторы","Default format":"Формат по умолчанию","Comment chunks":"Блоки комментариев","Metadata chunks":"Блоки метаданных","Exporting PSI to RAW":"Экспорт PSI в RAW","Exported verified PSI layout to {path}":"Проверенная структура PSI экспортирована в {path}"})
CATALOG["ar"].update({"Inspect / export PSI…":"فحص / تصدير PSI…","Inspect PSI image":"فحص صورة PSI","PSI files (*.psi);;All files (*)":"ملفات PSI (*.psi);;كل الملفات (*)","Inspecting PSI image":"جارٍ فحص صورة PSI","PSI inspection":"فحص PSI","Compressed sectors":"قطاعات مضغوطة","Default format":"التنسيق الافتراضي","Comment chunks":"كتل التعليقات","Metadata chunks":"كتل البيانات الوصفية","Exporting PSI to RAW":"جارٍ تصدير PSI إلى RAW","Exported verified PSI layout to {path}":"تم تصدير مخطط PSI المتحقق منه إلى {path}"})
CATALOG["ja"].update({"Inspect / export PSI…":"PSI を検査 / エクスポート…","Inspect PSI image":"PSI イメージを検査","PSI files (*.psi);;All files (*)":"PSI ファイル (*.psi);;すべてのファイル (*)","Inspecting PSI image":"PSI イメージを検査中","PSI inspection":"PSI 検査","Compressed sectors":"圧縮セクター","Default format":"既定の形式","Comment chunks":"コメントチャンク","Metadata chunks":"メタデータチャンク","Exporting PSI to RAW":"PSI を RAW にエクスポート中","Exported verified PSI layout to {path}":"検証済み PSI レイアウトを {path} にエクスポートしました"})


# v0.10 PRI bitstream structural inspector; deliberately no decode or RAW export.
CATALOG["zh_CN"].update({"Inspect PRI structure…":"检查 PRI 结构…","Inspect PRI structure":"检查 PRI 结构","PRI files (*.pri);;All files (*)":"PRI 文件 (*.pri);;所有文件 (*)","Inspecting PRI structure":"正在检查 PRI 结构","PRI structural inspection":"PRI 结构检查","Tracks with data":"含数据轨道","Total bits":"总位数","Clock range":"时钟范围","Read-only bitstream":"只读位流","No decoding or RAW export is available.":"不提供解码或 RAW 导出。","Fuzzy events":"模糊事件","Clock events":"时钟事件","Weak events":"弱位事件","Unknown chunks":"未知块"})
CATALOG["es"].update({"Inspect PRI structure…":"Inspeccionar estructura PRI…","Inspect PRI structure":"Inspeccionar estructura PRI","PRI files (*.pri);;All files (*)":"Archivos PRI (*.pri);;Todos los archivos (*)","Inspecting PRI structure":"Inspeccionando estructura PRI","PRI structural inspection":"Inspección estructural PRI","Tracks with data":"Pistas con datos","Total bits":"Bits totales","Clock range":"Rango de reloj","Read-only bitstream":"Flujo de bits de solo lectura","No decoding or RAW export is available.":"No hay decodificación ni exportación RAW disponibles.","Fuzzy events":"Eventos difusos","Clock events":"Eventos de reloj","Weak events":"Eventos débiles","Unknown chunks":"Bloques desconocidos"})
CATALOG["fr"].update({"Inspect PRI structure…":"Inspecter la structure PRI…","Inspect PRI structure":"Inspecter la structure PRI","PRI files (*.pri);;All files (*)":"Fichiers PRI (*.pri);;Tous les fichiers (*)","Inspecting PRI structure":"Inspection de la structure PRI","PRI structural inspection":"Inspection structurelle PRI","Tracks with data":"Pistes avec données","Total bits":"Bits totaux","Clock range":"Plage d’horloge","Read-only bitstream":"Flux binaire en lecture seule","No decoding or RAW export is available.":"Aucun décodage ni exportation RAW n’est disponible.","Fuzzy events":"Événements flous","Clock events":"Événements d’horloge","Weak events":"Événements faibles","Unknown chunks":"Blocs inconnus"})
CATALOG["ru"].update({"Inspect PRI structure…":"Проверить структуру PRI…","Inspect PRI structure":"Проверить структуру PRI","PRI files (*.pri);;All files (*)":"Файлы PRI (*.pri);;Все файлы (*)","Inspecting PRI structure":"Проверка структуры PRI","PRI structural inspection":"Структурная проверка PRI","Tracks with data":"Дорожки с данными","Total bits":"Всего битов","Clock range":"Диапазон тактовой частоты","Read-only bitstream":"Битовый поток только для чтения","No decoding or RAW export is available.":"Декодирование и экспорт RAW недоступны.","Fuzzy events":"Нечёткие события","Clock events":"Тактовые события","Weak events":"События слабых битов","Unknown chunks":"Неизвестные блоки"})
CATALOG["ar"].update({"Inspect PRI structure…":"فحص بنية PRI…","Inspect PRI structure":"فحص بنية PRI","PRI files (*.pri);;All files (*)":"ملفات PRI (*.pri);;كل الملفات (*)","Inspecting PRI structure":"جارٍ فحص بنية PRI","PRI structural inspection":"فحص بنية PRI","Tracks with data":"المسارات ذات البيانات","Total bits":"إجمالي البتات","Clock range":"نطاق الساعة","Read-only bitstream":"تدفق بتات للقراءة فقط","No decoding or RAW export is available.":"لا يتوفر فك ترميز أو تصدير RAW.","Fuzzy events":"أحداث ضبابية","Clock events":"أحداث الساعة","Weak events":"أحداث البتات الضعيفة","Unknown chunks":"كتل غير معروفة"})
CATALOG["ja"].update({"Inspect PRI structure…":"PRI 構造を検査…","Inspect PRI structure":"PRI 構造を検査","PRI files (*.pri);;All files (*)":"PRI ファイル (*.pri);;すべてのファイル (*)","Inspecting PRI structure":"PRI 構造を検査中","PRI structural inspection":"PRI 構造検査","Tracks with data":"データを含むトラック","Total bits":"総ビット数","Clock range":"クロック範囲","Read-only bitstream":"読み取り専用ビットストリーム","No decoding or RAW export is available.":"デコードおよび RAW エクスポートは利用できません。","Fuzzy events":"ファジーイベント","Clock events":"クロックイベント","Weak events":"弱ビットイベント","Unknown chunks":"不明なチャンク"})


# v0.10 86F v2.12 restricted bitstream structural inspector.
CATALOG["zh_CN"].update({"Inspect 86F structure…":"检查 86F 结构…","Inspect 86F structure":"检查 86F 结构","86F files (*.86f);;All files (*)":"86F 文件 (*.86f);;所有文件 (*)","Inspecting 86F structure":"正在检查 86F 结构","86F structural inspection":"86F 结构检查","Missing tracks":"缺失轨道","Sides":"面数","Total bitcells":"总位元数","Disk flags":"磁盘标志","Surface description":"表面描述","Offset table entries":"偏移表条目","Encoded bytes":"编码字节"})
CATALOG["es"].update({"Inspect 86F structure…":"Inspeccionar estructura 86F…","Inspect 86F structure":"Inspeccionar estructura 86F","86F files (*.86f);;All files (*)":"Archivos 86F (*.86f);;Todos los archivos (*)","Inspecting 86F structure":"Inspeccionando estructura 86F","86F structural inspection":"Inspección estructural 86F","Missing tracks":"Pistas ausentes","Sides":"Caras","Total bitcells":"Celdas de bits totales","Disk flags":"Indicadores de disco","Surface description":"Descripción de superficie","Offset table entries":"Entradas de tabla de desplazamientos","Encoded bytes":"Bytes codificados"})
CATALOG["fr"].update({"Inspect 86F structure…":"Inspecter la structure 86F…","Inspect 86F structure":"Inspecter la structure 86F","86F files (*.86f);;All files (*)":"Fichiers 86F (*.86f);;Tous les fichiers (*)","Inspecting 86F structure":"Inspection de la structure 86F","86F structural inspection":"Inspection structurelle 86F","Missing tracks":"Pistes absentes","Sides":"Faces","Total bitcells":"Cellules de bits totales","Disk flags":"Indicateurs de disque","Surface description":"Description de surface","Offset table entries":"Entrées de table de décalages","Encoded bytes":"Octets encodés"})
CATALOG["ru"].update({"Inspect 86F structure…":"Проверить структуру 86F…","Inspect 86F structure":"Проверить структуру 86F","86F files (*.86f);;All files (*)":"Файлы 86F (*.86f);;Все файлы (*)","Inspecting 86F structure":"Проверка структуры 86F","86F structural inspection":"Структурная проверка 86F","Missing tracks":"Отсутствующие дорожки","Sides":"Стороны","Total bitcells":"Всего битовых ячеек","Disk flags":"Флаги диска","Surface description":"Описание поверхности","Offset table entries":"Записи таблицы смещений","Encoded bytes":"Кодированные байты"})
CATALOG["ar"].update({"Inspect 86F structure…":"فحص بنية 86F…","Inspect 86F structure":"فحص بنية 86F","86F files (*.86f);;All files (*)":"ملفات 86F (*.86f);;كل الملفات (*)","Inspecting 86F structure":"جارٍ فحص بنية 86F","86F structural inspection":"فحص بنية 86F","Missing tracks":"المسارات المفقودة","Sides":"الوجوه","Total bitcells":"إجمالي خلايا البت","Disk flags":"علامات القرص","Surface description":"وصف السطح","Offset table entries":"إدخالات جدول الإزاحة","Encoded bytes":"البايتات المرمزة"})
