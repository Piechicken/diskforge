...
|---|---|---|
| Windows x64 | `DiskForge-v0.1.0-windows-x64.zip` | Descomprima y ejecute `DiskForge.exe`. |
| Linux x64 | `DiskForge-v0.1.0-linux-x64.zip` | Descomprima y ejecute `./DiskForge`. |
| macOS Intel | `DiskForge-v0.1.0-macos-intel-x64.zip` | Descomprima y mueva `DiskForge.app` a Aplicaciones. |
| macOS Apple Silicon | `DiskForge-v0.1.0-macos-arm64.zip` | Descomprima y mueva `DiskForge.app` a Aplicaciones. |
